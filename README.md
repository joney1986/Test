...
-   An **AI Resume Builder** that takes structured user input (experience, education, etc.) and generates a professionally formatted, downloadable PDF resume.
...
-   `/builder` (Resume Builder): Contains a form to build a resume. It makes API calls to the `/generate-resume` endpoint, which returns a downloadable PDF file of the generated resume.
